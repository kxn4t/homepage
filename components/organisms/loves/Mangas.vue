    ...
    return {
      items: [
        ...
        },
        {
          ...
          title: '箱入りドロップス',
          content:
            'どうしてアニメ化しないのかが不思議な作品No.1。徐々にお互いを意識していくなかで、あの最終巻。思わず号泣しながら読みました…。みんな幸せそうで何より。本当に本当にいい作品だった。(全6巻)',
          tags: [],
        },
        {
          img: '',
        ...
        },
        {
          ...
          title: 'ARIA (+AQUA)',
          content:
            '元気がなくなったときに読む。人生のバイブル。本当にARIAには何度救われたかわからない…。今まで生きてこれたのは間違いなくARIAのおかげ。明日からまた頑張ろう。(全2+12巻)',
          tags: ['アリス・キャロル'],
        },
      ],
    }
